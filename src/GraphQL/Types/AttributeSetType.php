        ...
        return new ObjectType([
            ...
            'fields' => [
                'id' => [
                    ...
                    'resolve' => static fn (mixed $attributeValue): string => $attributeValue instanceof AbstractAttribute
                ...
                'items' => [
                    ...
                    'resolve' => static fn (mixed $attributeValue): array => $attributeValue instanceof AbstractAttribute
                        ? $attributeValue->getItems()
                        : (is_array($attributeValue) && isset($attributeValue['items']) && is_array($attributeValue['items'])
