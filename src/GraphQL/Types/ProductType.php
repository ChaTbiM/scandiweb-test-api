...
{
    public static function build(TypeRegistry $registry, AttributeRepositoryInterface $attributeRepository): ObjectType
    {
        return new ObjectType([
            ...
            'fields' => static function () use ($registry, $attributeRepository): array {
                return [
                    ...
                    'attributes' => [
                        'type' => Type::nonNull(Type::listOf(Type::nonNull($registry->attributeSet()))),
